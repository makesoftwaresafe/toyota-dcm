...
#ifndef DNSMASQ_HARNESS_FAKENETLINKGETADDRSTATE_H
#define DNSMASQ_HARNESS_FAKENETLINKGETADDRSTATE_H

#include "State.h"

class FakeNetlinkGetAddrState
    : public State,
      public std::enable_shared_from_this<FakeNetlinkGetAddrState> {
 public:
  FakeNetlinkGetAddrState(uint32_t seq, uint32_t pid);
...
#endif  // DNSMASQ_HARNESS_FAKENETLINKGETADDRSTATE_H
