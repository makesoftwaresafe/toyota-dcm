...
#ifndef DNSMASQ_HARNESS_FAKENETLINKDONESTATE_H
#define DNSMASQ_HARNESS_FAKENETLINKDONESTATE_H

#include "State.h"

class FakeNetlinkDoneState
    : public State,
      public std::enable_shared_from_this<FakeNetlinkDoneState> {
 public:
  FakeNetlinkDoneState(uint32_t seq, uint32_t pid);
...
#endif  // DNSMASQ_HARNESS_FAKENETLINKDONESTATE_H
